...
ver2.2
beta, gammaの推定を行うかどうかをconfigで指定できるようにした   
"""
...
def main():
    ...
    for ep in range(epoch):
        ...
        for i in tqdm(range(int(min_data_length/minibatch_j))):
            ...
            out,_,beta,gamma=model.forward(data,is_beta=model_conf["is-beta"],is_gamma=model_conf["is-gamma"],return_internal_param=True)
